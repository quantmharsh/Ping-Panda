    ...
    <div className="flex  min-h-[800px] w-full  max-w-[1200px] bg-discord-background text-white rounded-lg  overflow-hidden shadow-xl ">
      ...
      <div className=" hidden sm:flex w-[72px]  bg-[#202225]  py-3 flex-col items-center">
        ...
        {[...Array(5)].map((_, i) => (
          <div
            key={i}
            className="size-12 bg-discord-background rounded-3xl flex items-center justify-center  mb-3 hover:rounded-xl  transition-all duration-300 hover:bg-discord-brand-color cursor-not-allowed "
          >
            ...
            <div className="my-1 space-y-px">
              {[...Array(5)].map((_, i) => (
                ...
                >
                  ...
                  <span className="font-medium ">Quantam {i + 1}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="h-16 bg-[#36393f] flex items-center px-4 shadow-sm border-b border-[#202225">
          ...
          <div className="ml-auto flex items-center space-x-4 text-[#b9bbbe]">
            ...
            <UserCircle2 className="size-5 hover:text-white cursor-not-allowed hidden sm:block" />
